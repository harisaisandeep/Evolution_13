...
Chintan Shah (+91 7830933061)
        ...
        <div id="ideazDetails" style="opacity:1">
...
-->
            <div style="position:relative; font-size:20px; float:left; left:365px; top:180px;"><b style="font-family: 'Unica One', cursive, Helvetica, Arial, sans-serif;  font-size: 1.6em; color:#000">TITLE SPONSOR:</b></div>
	  ...
	  <div class="sponsor1" title="Click to flip">
				...
				<div class="sponsor" title="Click to flip">
					...
					<div class="sponsorData">
						...
						<div class="sponsorURL">
							<a target="_blank" href="http://www.shreyansgroup.com/">http://www.shreyansgroup.com/</a>
						</div>
					</div>
				</div>
	  ...
	  <div class="sponsor" title="Click to flip">
				...
				<div class="sponsor" title="Click to flip">
					...
					<div class="sponsorData">
						...
						<div class="sponsorURL">
							<a target="_blank" href="http://www.candcinfrastructure.com/">http://www.candcinfrastructure.com/</a>
						</div>
					</div>
